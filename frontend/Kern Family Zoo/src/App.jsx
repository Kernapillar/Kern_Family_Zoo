...
function App() {
  ...
  {id: 2, src: frog1, legs: 4, name: "", scientificName: ""},
  {id: 3, src: bird1, legs: 2, name: "", scientificName: ""},
  {id: 4, src: snake1, legs: 0, name: "", scientificName: ""}, 
  {id: 5, src: snake2,  legs: 0, name: "", scientificName: "p"},
  {id: 6, src: chameleon1, legs: 4, name: "", scientificName: ""},
  {id: 7, src: spider1, legs: 8, name: "", scientificName: ""}, 
  {id: 8, src: spider2, legs: 8, name: "", scientificName: ""},
  {id: 9, src: spider3, legs: 8, name: "", scientificName: ""},
  {id: 10, src: bird2, legs: 2, name: "", scientificName: ""}, 
  {id: 11, src: snake3, legs: 0, name: "", scientificName: "p"},
  {id: 12, src: snake4, legs: 0, name: "", scientificName: ""},
  {id: 13, src: bird3, legs: 2, name: "", scientificName: ""}, 
  {id: 14, src: bird4, legs: 2, name: "", scientificName: ""},
  {id: 15, src: lizard1, legs: 4, name: "", scientificName: ""},
  {id: 16, src: bird5, legs: 2, name: "", scientificName: ""}, 
  {id: 17, src: bird6, legs: 2, name: "", scientificName: "p"},
  {id: 18, src: snake5, legs: 0, name: "", scientificName: ""}, 
  {id: 19, src: lizard2, legs: 4, name: "", scientificName: ""},
  {id: 20, src: spider4, legs: 8, name: "", scientificName: ""},
  {id: 21, src: spider5, legs: 8, name: "", scientificName: ""}, 
  {id: 22, src: frog2, legs: 4, name: "", scientificName: "p"},
  {id: 23, src: frog3, legs: 4, name: "", scientificName: ""},
  {id: 24, src: gecko1, legs: 4, name: "", scientificName: ""}, 
  {id: 25, src: gecko2, legs: 4, name: "", scientificName: ""},
